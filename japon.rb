...
#maaf kalo terjadi bug,gue lagi belajar record punya orang:(

#kalo mau record,silahkan tapi jangan diperjualbelikan
...
WhatsApp: -
Facebook: https://www.facebook.com/see.phutri
Github  : github.com/FenzX
...
def LoginAkun
  begin
    system ('clear')
    puts ($logo)
    puts ("[1] Login Via Access Token")
    puts ("[2] Login Via Cookies")
    puts ("[0] Exit")
